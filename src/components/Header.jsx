        ...
        <header className="fixed right-0 top-0 left-60 bg-yellow-50 py-3 px-4 h-16">
            <div className="flex justify-between items-center max-w-4xl mx-auto">
                <button
                    ...
                    className="flex items-center text-gray-600 font-semibold hover:text-yellow-600 transition transform hover:scale-105 duration-200">
                ...
                <h1 className="text-lg font-bold">Task's</h1>
                <button
